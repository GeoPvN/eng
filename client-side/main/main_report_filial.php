...
var i 		= 0;
var done 	= ['','','','','','',''];
var aJaxURL	= "server-side/main_report_filial.action.php";		//server side folder url
var tName   = "report";
...
function drawFirstLevel(){
		...
		var d_url   ="&start="+start+"&end="+end+"&done="+i+"&type="+done[0]+"&category="+done[1]+"&sub_category="+done[2]+"&branches="+branches;
