...
<head>
	<script type="text/javascript">
		var aJaxURL	= "server-side/view/inc_status.action.php";		//server side folder url
...
<body>
<div id="tabs">
<div class="callapp_head">რეაგირება<hr class="callapp_head_hr"></div>
<div id="button_area">
...
<td style="cursor: pointer;padding: 4px;border-right: 1px solid #A3D0E4;" id="show_copy_prit_exel" myvar="0"><img alt="link" src="media/images/icons/select.png" height="14" width="14">
    ...
    <!-- jQuery Dialog -->
    <div id="add-edit-form" class="form-dialog" title="რეაგირება">
    	<!-- aJax -->
	</div>
</body>
</html>
