...
<head>
	<script type="text/javascript">
		var aJaxURL	= "server-side/view/author.action.php";		//server side folder url
		...
		function LoadTable(){
			...
			GetDataTable(tName, aJaxURL, "get_list", 6, "", 0, "", 1, "desc", "", change_colum_main);
			setTimeout(function(){
	    ...
	    $(document).on("click", "#save-dialog", function () {
	    	...
	    	param.link		= $("#link").val();
	    	param.sc_id		= $("#service_center_id").val();
...
<body>
<div id="tabs">
<div class="callapp_head">ბილინგის იუზერები<hr class="callapp_head_hr"></div>
<div id="button_area">
...
<td style="cursor: pointer;padding: 4px;border-right: 1px solid #A3D0E4;" id="show_copy_prit_exel" myvar="0"><img alt="link" src="media/images/icons/select.png" height="14" width="14">
    ...
    <table class="display" id="example">
        <thead>
            <tr id="datatable_header">
                <th>ID</th>
                <th style="width: 5%;">№</th>
                <th style="width: 23%;">მომსახურების ცენტრი</th>
                <th style="width: 23%;">იუზერი</th>
                <th style="width: 23%;">პაროლი</th>
                <th style="width: 23%;">ლინკი</th>
            	<th class="check">#</th>
            </tr>
        </thead>
        <thead>
    ...
    <!-- jQuery Dialog -->
    <div id="add-edit-form" class="form-dialog" title="ბილინგის იუზერები">
    	<!-- aJax -->
	</div>
</body>
</html>