...
<body>
<div id="tabs">
<div class="callapp_head">Service Center  / District<hr class="callapp_head_hr"></div>
<div id="button_area">
...
<table  class="display" id="example">
    ...
    <!-- jQuery Dialog -->
    <div id="add-edit-form" class="form-dialog" title="Service Center / branch / District">
    	<!-- aJax -->
	</div>
</body>
</html>
