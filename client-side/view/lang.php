...
<head>
	<script type="text/javascript">
		var aJaxURL	= "server-side/view/lang.action.php";		//server side folder url
...
<body>
<div id="tabs">
<div class="callapp_head">სასაუბრო ენა<hr class="callapp_head_hr"></div>
<div id="button_area">
    ...
    <table class="display" id="example">
        <thead>
            <tr id="datatable_header">
                <th>ID</th>
                <th style="width: 100%;">სასაუბრო ენა</th>
            	<th class="check">#</th>
            </tr>
        </thead>
        <thead>
