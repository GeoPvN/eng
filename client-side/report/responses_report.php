...
var i 		= 0;
var done 	= ['','','','','','',''];
var aJaxURL	= "server-side/report/responses_report.action.php";		//server side folder url
var tName   = "report";
...
<body>
	<div id="tabs" style="width: 90%; height: 850px;">
		<div class="callapp_head">By Response<hr class="callapp_head_hr"></div>
...
<thead>
        <tr id="datatable_header">
            ...
            <th style="width: 25%;">Customer Number</th>
